 ...
 * @method     ChildProcedimentoQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildProcedimentoQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildProcedimentoQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildProcedimentoQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildProcedimentoQuery leftJoinRegistroProcedimento($relationAlias = null) Adds a LEFT JOIN clause to the query using the RegistroProcedimento relation
 * @method     ChildProcedimentoQuery rightJoinRegistroProcedimento($relationAlias = null) Adds a RIGHT JOIN clause to the query using the RegistroProcedimento relation
 * @method     ChildProcedimentoQuery innerJoinRegistroProcedimento($relationAlias = null) Adds a INNER JOIN clause to the query using the RegistroProcedimento relation
 *
 * @method     ChildProcedimentoQuery joinWithRegistroProcedimento($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the RegistroProcedimento relation
 *
 * @method     ChildProcedimentoQuery leftJoinWithRegistroProcedimento() Adds a LEFT JOIN clause and with to the query using the RegistroProcedimento relation
 ...
 * @method     ChildProcedimento[]|Collection findById(int $id) Return ChildProcedimento objects filtered by the id column
 ...
 *
 */
abstract class ProcedimentoQuery extends ModelCriteria
{
    ...
    /**
     * Returns a new ChildProcedimentoQuery object.
     *
     * @param string $modelAlias The alias of a model in the query
     * @param Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildProcedimentoQuery
     */
    public static function create(?string $modelAlias = null, ?Criteria $criteria = null): Criteria
    {
        if ($criteria instanceof ChildProcedimentoQuery) {
            return $criteria;
        }
        $query = new ChildProcedimentoQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildProcedimento|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ProcedimentoTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
     ...
     *
     * @return ChildProcedimento A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildProcedimento $obj */
            $obj = new ChildProcedimento();
            $obj->hydrate($row);
            ProcedimentoTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ProcedimentoTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ProcedimentoTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(ProcedimentoTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(ProcedimentoTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $this->addUsingAlias(ProcedimentoTableMap::COL_ID, $id, $comparison);
    ...
    /**
     * Filter the query by a related Registro object
     * using the registro_procedimento table as cross reference
     *
     * @param Registro $registro the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByRegistro($registro, string $comparison = Criteria::EQUAL)
    {
        $this
            ->useRegistroProcedimentoQuery()
            ->filterByRegistro($registro, $comparison)
            ->endUse();
     ...
     *
     * @param ChildProcedimento $procedimento Object to remove from the list of results
     *
     * @return $this The current query, for fluid interface
     */
    public function prune($procedimento = null)
    {
        if ($procedimento) {
            $this->addUsingAlias(ProcedimentoTableMap::COL_ID, $procedimento->getId(), Criteria::NOT_EQUAL);
        }
    ...
    public function doDeleteAll(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            ProcedimentoTableMap::clearRelatedInstancePool();
    ...
    public function delete(?ConnectionInterface $con = null): int
    {
        ...
        $criteria->setDbName(ProcedimentoTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            ProcedimentoTableMap::removeInstanceFromPool($criteria);
