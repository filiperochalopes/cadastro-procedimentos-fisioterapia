 ...
 */
abstract class TabelaDeprecated implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Api\\Models\\Map\\TabelaDeprecatedTableMap';
    ...
    /**
     * Initializes internal state of Api\Models\Base\TabelaDeprecated object.
     */
    ...
    /**
     * Compares this with another <code>TabelaDeprecated</code> instance.  If
     * <code>obj</code> is an instance of <code>TabelaDeprecated</code>, delegates to
     * <code>equals(TabelaDeprecated)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_ID] = true;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== null || $dt !== null) {
            if ($this->data === null || $dt === null || $dt->format("Y-m-d") !== $this->data->format("Y-m-d")) {
                ...
                $this->modifiedColumns[TabelaDeprecatedTableMap::COL_DATA] = true;
            }
    ...
    public function setTurno($v)
    {
        ...
        if ($this->turno !== $v) {
            $this->turno = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_TURNO] = true;
        }
    ...
    public function setFisioterapeuta($v)
    {
        ...
        if ($this->fisioterapeuta !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_FISIOTERAPEUTA] = true;
        }
    ...
    public function setNomePaciente($v)
    {
        ...
        if ($this->nome_paciente !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_NOME_PACIENTE] = true;
        }
    ...
    public function setTipoAtendimento($v)
    {
        ...
        if ($this->tipo_atendimento !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_TIPO_ATENDIMENTO] = true;
        }
    ...
    public function setSituacaoAdministrativa($v)
    {
        ...
        if ($this->situacao_administrativa !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_SITUACAO_ADMINISTRATIVA] = true;
        }
    ...
    public function setNipPaciente($v)
    {
        ...
        if ($this->nip_paciente !== $v) {
            $this->nip_paciente = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_NIP_PACIENTE] = true;
        }
    ...
    public function setNipTitular($v)
    {
        ...
        if ($this->nip_titular !== $v) {
            $this->nip_titular = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_NIP_TITULAR] = true;
        }
    ...
    public function setCpfTitular($v)
    {
        ...
        if ($this->cpf_titular !== $v) {
            $this->cpf_titular = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_CPF_TITULAR] = true;
        }
    ...
    public function setOrigem($v)
    {
        ...
        if ($this->origem !== $v) {
            $this->origem = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_ORIGEM] = true;
        }
    ...
    public function setCorpoQuadro($v)
    {
        ...
        if ($this->corpo_quadro !== $v) {
            $this->corpo_quadro = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_CORPO_QUADRO] = true;
        }
    ...
    public function setPostoGraduacao($v)
    {
        ...
        if ($this->posto_graduacao !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_POSTO_GRADUACAO] = true;
        }
    ...
    public function setAtleta($v)
    {
        ...
        if ($this->atleta !== $v) {
            $this->atleta = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_ATLETA] = true;
        }
    ...
    public function setModalidade($v)
    {
        ...
        if ($this->modalidade !== $v) {
            $this->modalidade = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_MODALIDADE] = true;
        }
    ...
    public function setOutraModalidade($v)
    {
        ...
        if ($this->outra_modalidade !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_OUTRA_MODALIDADE] = true;
        }
    ...
    public function setComparecimento($v)
    {
        ...
        if ($this->comparecimento !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_COMPARECIMENTO] = true;
        }
    ...
    public function setTipoFalta($v)
    {
        ...
        if ($this->tipo_falta !== $v) {
            $this->tipo_falta = $v;
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_TIPO_FALTA] = true;
        }
    ...
    public function setProcedimento1($v)
    {
        ...
        if ($this->procedimento_1 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_1] = true;
        }
    ...
    public function setProcedimento2($v)
    {
        ...
        if ($this->procedimento_2 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_2] = true;
        }
    ...
    public function setProcedimento3($v)
    {
        ...
        if ($this->procedimento_3 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_3] = true;
        }
    ...
    public function setProcedimento4($v)
    {
        ...
        if ($this->procedimento_4 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_4] = true;
        }
    ...
    public function setProcedimento5($v)
    {
        ...
        if ($this->procedimento_5 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_5] = true;
        }
    ...
    public function setProcedimento6($v)
    {
        ...
        if ($this->procedimento_6 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_6] = true;
        }
    ...
    public function setProcedimento7($v)
    {
        ...
        if ($this->procedimento_7 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_7] = true;
        }
    ...
    public function setProcedimento8($v)
    {
        ...
        if ($this->procedimento_8 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_8] = true;
        }
    ...
    public function setProcedimento9($v)
    {
        ...
        if ($this->procedimento_9 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_9] = true;
        }
    ...
    public function setProcedimento10($v)
    {
        ...
        if ($this->procedimento_10 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_10] = true;
        }
    ...
    public function setProcedimento11($v)
    {
        ...
        if ($this->procedimento_11 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_11] = true;
        }
    ...
    public function setProcedimento12($v)
    {
        ...
        if ($this->procedimento_12 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_12] = true;
        }
    ...
    public function setProcedimento13($v)
    {
        ...
        if ($this->procedimento_13 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_13] = true;
        }
    ...
    public function setProcedimento14($v)
    {
        ...
        if ($this->procedimento_14 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_14] = true;
        }
    ...
    public function setProcedimento15($v)
    {
        ...
        if ($this->procedimento_15 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_15] = true;
        }
    ...
    public function setProcedimento16($v)
    {
        ...
        if ($this->procedimento_16 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_16] = true;
        }
    ...
    public function setProcedimento17($v)
    {
        ...
        if ($this->procedimento_17 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_17] = true;
        }
    ...
    public function setProcedimento18($v)
    {
        ...
        if ($this->procedimento_18 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_18] = true;
        }
    ...
    public function setProcedimento19($v)
    {
        ...
        if ($this->procedimento_19 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_19] = true;
        }
    ...
    public function setProcedimento20($v)
    {
        ...
        if ($this->procedimento_20 !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_PROCEDIMENTO_20] = true;
        }
    ...
    public function setTotalProcedimentos($v)
    {
        ...
        if ($this->total_procedimentos !== $v) {
            ...
            $this->modifiedColumns[TabelaDeprecatedTableMap::COL_TOTAL_PROCEDIMENTOS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->data = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Turno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->turno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Fisioterapeuta', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fisioterapeuta = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TabelaDeprecatedTableMap::translateFieldName('NomePaciente', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nome_paciente = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TabelaDeprecatedTableMap::translateFieldName('TipoAtendimento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tipo_atendimento = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TabelaDeprecatedTableMap::translateFieldName('SituacaoAdministrativa', TableMap::TYPE_PHPNAME, $indexType)];
            $this->situacao_administrativa = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : TabelaDeprecatedTableMap::translateFieldName('NipPaciente', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nip_paciente = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : TabelaDeprecatedTableMap::translateFieldName('NipTitular', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nip_titular = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : TabelaDeprecatedTableMap::translateFieldName('CpfTitular', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cpf_titular = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Origem', TableMap::TYPE_PHPNAME, $indexType)];
            $this->origem = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : TabelaDeprecatedTableMap::translateFieldName('CorpoQuadro', TableMap::TYPE_PHPNAME, $indexType)];
            $this->corpo_quadro = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : TabelaDeprecatedTableMap::translateFieldName('PostoGraduacao', TableMap::TYPE_PHPNAME, $indexType)];
            $this->posto_graduacao = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Atleta', TableMap::TYPE_PHPNAME, $indexType)];
            $this->atleta = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Modalidade', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modalidade = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : TabelaDeprecatedTableMap::translateFieldName('OutraModalidade', TableMap::TYPE_PHPNAME, $indexType)];
            $this->outra_modalidade = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Comparecimento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comparecimento = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : TabelaDeprecatedTableMap::translateFieldName('TipoFalta', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tipo_falta = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento7', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_7 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento8', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_8 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento9', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_9 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento10', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_10 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento11', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_11 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento12', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_12 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento13', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_13 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento14', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_14 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento15', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_15 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento16', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_16 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento17', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_17 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento18', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_18 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento19', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_19 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : TabelaDeprecatedTableMap::translateFieldName('Procedimento20', TableMap::TYPE_PHPNAME, $indexType)];
            $this->procedimento_20 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : TabelaDeprecatedTableMap::translateFieldName('TotalProcedimentos', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 39; // 39 = TabelaDeprecatedTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Api\\Models\\TabelaDeprecated'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildTabelaDeprecatedQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see TabelaDeprecated::setDeleted()
     * @see TabelaDeprecated::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTabelaDeprecatedQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TabelaDeprecatedTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_DATA)) {
            $modifiedColumns[':p' . $index++]  = 'data';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_TURNO)) {
            $modifiedColumns[':p' . $index++]  = 'turno';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_FISIOTERAPEUTA)) {
            $modifiedColumns[':p' . $index++]  = 'fisioterapeuta';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_NOME_PACIENTE)) {
            $modifiedColumns[':p' . $index++]  = 'nome_paciente';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_TIPO_ATENDIMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'tipo_atendimento';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_SITUACAO_ADMINISTRATIVA)) {
            $modifiedColumns[':p' . $index++]  = 'situacao_administrativa';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_NIP_PACIENTE)) {
            $modifiedColumns[':p' . $index++]  = 'nip_paciente';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_NIP_TITULAR)) {
            $modifiedColumns[':p' . $index++]  = 'nip_titular';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_CPF_TITULAR)) {
            $modifiedColumns[':p' . $index++]  = 'cpf_titular';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_ORIGEM)) {
            $modifiedColumns[':p' . $index++]  = 'origem';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_CORPO_QUADRO)) {
            $modifiedColumns[':p' . $index++]  = 'corpo_quadro';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_POSTO_GRADUACAO)) {
            $modifiedColumns[':p' . $index++]  = 'posto_graduacao';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_ATLETA)) {
            $modifiedColumns[':p' . $index++]  = 'atleta';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_MODALIDADE)) {
            $modifiedColumns[':p' . $index++]  = 'modalidade';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_OUTRA_MODALIDADE)) {
            $modifiedColumns[':p' . $index++]  = 'outra_modalidade';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_COMPARECIMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'comparecimento';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_TIPO_FALTA)) {
            $modifiedColumns[':p' . $index++]  = 'tipo_falta';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_1)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_1';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_2)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_2';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_3)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_3';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_4)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_4';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_5)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_5';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_6)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_6';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_7)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_7';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_8)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_8';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_9)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_9';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_10)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_10';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_11)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_11';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_12)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_12';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_13)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_13';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_14)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_14';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_15)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_15';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_16)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_16';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_17)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_17';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_18)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_18';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_19)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_19';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_20)) {
            $modifiedColumns[':p' . $index++]  = 'procedimento_20';
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_TOTAL_PROCEDIMENTOS)) {
    ...
    {
        $pos = TabelaDeprecatedTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TabelaDeprecated'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['TabelaDeprecated'][$this->hashCode()] = true;
        $keys = TabelaDeprecatedTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getData(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_ID)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_DATA)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_DATA, $this->data);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_TURNO)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_TURNO, $this->turno);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_FISIOTERAPEUTA)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_FISIOTERAPEUTA, $this->fisioterapeuta);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_NOME_PACIENTE)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_NOME_PACIENTE, $this->nome_paciente);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_TIPO_ATENDIMENTO)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_TIPO_ATENDIMENTO, $this->tipo_atendimento);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_SITUACAO_ADMINISTRATIVA)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_SITUACAO_ADMINISTRATIVA, $this->situacao_administrativa);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_NIP_PACIENTE)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_NIP_PACIENTE, $this->nip_paciente);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_NIP_TITULAR)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_NIP_TITULAR, $this->nip_titular);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_CPF_TITULAR)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_CPF_TITULAR, $this->cpf_titular);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_ORIGEM)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_ORIGEM, $this->origem);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_CORPO_QUADRO)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_CORPO_QUADRO, $this->corpo_quadro);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_POSTO_GRADUACAO)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_POSTO_GRADUACAO, $this->posto_graduacao);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_ATLETA)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_ATLETA, $this->atleta);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_MODALIDADE)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_MODALIDADE, $this->modalidade);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_OUTRA_MODALIDADE)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_OUTRA_MODALIDADE, $this->outra_modalidade);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_COMPARECIMENTO)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_COMPARECIMENTO, $this->comparecimento);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_TIPO_FALTA)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_TIPO_FALTA, $this->tipo_falta);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_1)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_1, $this->procedimento_1);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_2)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_2, $this->procedimento_2);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_3)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_3, $this->procedimento_3);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_4)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_4, $this->procedimento_4);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_5)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_5, $this->procedimento_5);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_6)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_6, $this->procedimento_6);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_7)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_7, $this->procedimento_7);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_8)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_8, $this->procedimento_8);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_9)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_9, $this->procedimento_9);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_10)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_10, $this->procedimento_10);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_11)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_11, $this->procedimento_11);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_12)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_12, $this->procedimento_12);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_13)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_13, $this->procedimento_13);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_14)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_14, $this->procedimento_14);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_15)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_15, $this->procedimento_15);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_16)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_16, $this->procedimento_16);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_17)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_17, $this->procedimento_17);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_18)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_18, $this->procedimento_18);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_19)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_19, $this->procedimento_19);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_20)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_PROCEDIMENTO_20, $this->procedimento_20);
        }
        if ($this->isColumnModified(TabelaDeprecatedTableMap::COL_TOTAL_PROCEDIMENTOS)) {
            $criteria->add(TabelaDeprecatedTableMap::COL_TOTAL_PROCEDIMENTOS, $this->total_procedimentos);
        }
    ...
    {
        $criteria = ChildTabelaDeprecatedQuery::create();
        $criteria->add(TabelaDeprecatedTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Api\Models\TabelaDeprecated (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Api\Models\TabelaDeprecated Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        return (string) $this->exportTo(TabelaDeprecatedTableMap::DEFAULT_STRING_FORMAT);
    }
