...
use \Exception;
use \PDO;
use Api\Models\Pacientes as ChildPacientes;
...
abstract class PacientesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Api\Models\Base\PacientesQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Api\\Models\\Pacientes', $modelAlias = null)
    {
