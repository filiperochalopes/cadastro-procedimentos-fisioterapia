...
use \Exception;
use \PDO;
use Api\Models\Usuario as ChildUsuario;
 ...
 *
 * @method     ChildUsuario[]|Collection find(?ConnectionInterface $con = null) Return ChildUsuario objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildUsuario> find(?ConnectionInterface $con = null) Return ChildUsuario objects based on current ModelCriteria
 * @method     ChildUsuario[]|Collection findById(int $id) Return ChildUsuario objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildUsuario> findById(int $id) Return ChildUsuario objects filtered by the id column
 * @method     ChildUsuario[]|Collection findByUsuario(string $usuario) Return ChildUsuario objects filtered by the usuario column
 * @psalm-method Collection&\Traversable<ChildUsuario> findByUsuario(string $usuario) Return ChildUsuario objects filtered by the usuario column
 * @method     ChildUsuario[]|Collection findBySenha(string $senha) Return ChildUsuario objects filtered by the senha column
 * @psalm-method Collection&\Traversable<ChildUsuario> findBySenha(string $senha) Return ChildUsuario objects filtered by the senha column
...
abstract class UsuarioQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Api\Models\Base\UsuarioQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Api\\Models\\Usuario', $modelAlias = null)
    {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(UsuarioTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(UsuarioTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(UsuarioTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByUsuario($usuario = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(UsuarioTableMap::COL_USUARIO, $usuario, $comparison);
    ...
    public function filterBySenha($senha = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(UsuarioTableMap::COL_SENHA, $senha, $comparison);
