...
class RegistrosTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Models.Map.RegistrosTableMap';
     ...
     */
    public const OM_CLASS = '\\Models\\Registros';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Models.Registros';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Models\\Registros');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Registros) { // it's a model object
