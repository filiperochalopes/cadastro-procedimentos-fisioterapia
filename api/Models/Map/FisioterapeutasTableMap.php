...
use Models\Fisioterapeutas;
use Models\FisioterapeutasQuery;
...
class FisioterapeutasTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Models.Map.FisioterapeutasTableMap';
     ...
     */
    public const OM_CLASS = '\\Models\\Fisioterapeutas';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Models.Fisioterapeutas';
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Models\\Fisioterapeutas');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Fisioterapeutas) { // it's a model object
