...
abstract class Registros implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\RegistrosTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Registros object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Registros'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Models\Registros (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Registros Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
