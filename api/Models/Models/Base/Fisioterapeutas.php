...
abstract class Fisioterapeutas implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\FisioterapeutasTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Fisioterapeutas object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Fisioterapeutas'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Models\Fisioterapeutas (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Fisioterapeutas Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
