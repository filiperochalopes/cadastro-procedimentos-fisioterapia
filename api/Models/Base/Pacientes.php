...
abstract class Pacientes implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Models\\Map\\PacientesTableMap';
    ...
    /**
     * Initializes internal state of Models\Base\Pacientes object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Pacientes'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Models\Pacientes (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Pacientes Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
