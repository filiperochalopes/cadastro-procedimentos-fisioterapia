...
abstract class Usuarios implements ActiveRecordInterface
{
    ...
    public function setUsuario($v)
    {
        ...
        if ($this->usuario !== $v) {
            $this->usuario = $v;
            $this->modifiedColumns[UsuariosTableMap::COL_USUARIO] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UsuariosTableMap::translateFieldName('Usuario', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_USUARIO)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(UsuariosTableMap::COL_USUARIO)) {
            $criteria->add(UsuariosTableMap::COL_USUARIO, $this->usuario);
        }
        if ($this->isColumnModified(UsuariosTableMap::COL_SENHA)) {
